...
- ① 위치는 절대 정답 불가
- 발문: "주어진 문장이 들어가기에 가장 적절한 곳은?"

### 글의 순서
- 주어진 첫 문단 이후 (A)(B)(C) 순서 배열
- ① (A)-(B)-(C) 정답 불가 (첫 번째 선택지가 정답이면 출제 의미 없음)
- 발문: "주어진 글 다음에 이어질 글의 순서로 가장 적절한 것은?"

### 어법
- 문장 내 밑줄 친 5개 중 틀린 것 고르기
- 준동사/관계사/수동태/시제 등 핵심 문법 포인트
- 발문: "다음 글의 밑줄 친 부분 중, 어법상 틀린 것은?"

### 어휘 (문맥에 맞지 않는 단어)
- 문장 내 밑줄 친 5개 중 문맥상 적절하지 않은 것 고르기
- 반의어 또는 전혀 다른 의미의 단어로 교체
...
7. 정답 번호 분포 규칙
   ...
   - 유형별 제한이 있는 경우 해당 제한을 우선 적용하세요
   - 나머지 번호들이 고르게 분포되도록 설계
